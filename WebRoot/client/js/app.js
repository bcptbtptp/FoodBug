...
var rootUrl = "http://192.168.31.207:8080/FoodYoujiBlog/";
...
function getTodayWeather(cityname){
    ...
    ajaxCallback("getWeather",{city:city},function(data){
        ...
        results = JSON.parse(results);
        var list = results.results[0]['weather_data'];
        $("#day12").html(list[0].date+"<br>"+"温度："+list[0].temperature+"<br>"+list[0].weather+":"+list[0].wind);
        $("#day1img2").attr("src",list[0].dayPictureUrl);
