...
<head id="Head1">
    ...
    if(roletype == "1"){
    	_menus = {
   	         "menus": [
   	             {"menuid": "1", "icon": "icon-magic", "menuname": "系统笔记管理",
   	                 "menus": [
   	                     {"menuid": "12", "menuname": "系统笔记管理列表", "icon": "icon-database", "url": "<%= __APP__%>/Good!good"}
   	                 ]},
   	              {"menuid": "1", "icon": "icon-magic", "menuname": "笔记管理",
   	   	                 "menus": [
   	   	                     {"menuid": "12", "menuname": "笔记列表", "icon": "icon-database", "url": "<%= __APP__%>/Good!good2"}
   	   	                 ]},
   	             {"menuid": "1", "icon": "icon-magic", "menuname": "城市管理",
   	                 "menus": [
   	                     {"menuid": "12", "menuname": "城市列表", "icon": "icon-database", "url": "<%= __APP__%>/Good!type"}
   	                 ]},

   	              {"menuid": "1", "icon": "icon-magic", "menuname": "留言板管理",
   	   	                 "menus": [
   	   	                     {"menuid": "12", "menuname": "留言列表", "icon": "icon-database", "url": "<%= __APP__%>/Posts!posts"}
   	   	                 ]},
   	   	           /*{"menuid": "1", "icon": "icon-magic", "menuname": "公告通知",
   		                 "menus": [
   		                     {"menuid": "12", "menuname": "公告通知", "icon": "icon-database", "url": "<%= __APP__%>/Notice!notice"}
   		                 ]}, */
