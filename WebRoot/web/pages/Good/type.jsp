...
<div id="managerDialog" class="easyui-dialog" title="城市管理" style="width:350px;height:150px;" toolbar="#dlg-toolbar"
...
<div id="viewDialog" class="easyui-dialog" title="系统笔记查看" style="width:450px;height:250px;" toolbar="#dlg-toolbar"
    ...
    <table cellpadding="1" cellspacing="1" class="tb_custom1">
        ...
        <tr>
            <th align="right"><label>详细描述：</label></th>
            <td colspan="3">
                <span id="note2"></span>
            </td>
        </tr>
