    ...
    $('#grid1').datagrid({
        ...
        columns: [
            [
                ...
                {title: '地点', width: 100, field: 'address', sortable: true}
            ]
        ], toolbar: [
            {
                text: '新增',
...
<div id="managerDialog" class="easyui-dialog" title="系统笔记管理" style="width:650px;height:350px;" toolbar="#dlg-toolbar"
        ...
        <table cellpadding="1" cellspacing="1" class="tb_custom1">
            <tr>
                ...
                <td width="30%">
                    ...
                    <input type="hidden" name="good.type" id="type">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3" width="30%">
                    <input type="text" name="address" id="address" style="width:200px;word-wrap: break-word;word-break:break-all;"/>
                </td>
            ...
            <tr>
                <th width="30%" align="right"><label>详细描述：</label></th>
                <td colspan="3" width="30%">
